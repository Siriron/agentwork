...
export const TASK_REGISTRY_ABI = [
  { name:'postTask',         type:'function', stateMutability:'nonpayable', inputs:[{name:'title',type:'string'},{name:'description',type:'string'},{name:'category',type:'string'},{name:'bounty',type:'uint256'},{name:'deadline',type:'uint256'}], outputs:[{name:'taskId',type:'uint256'}] },
  ...
  { name:'getTaskCore',      type:'function', stateMutability:'view',       inputs:[{name:'taskId',type:'uint256'}], outputs:[{name:'',type:'tuple',components:[{name:'id',type:'uint256'},{name:'poster',type:'address'},{name:'assignedAgent',type:'address'},{name:'bounty',type:'uint256'},{name:'deadline',type:'uint256'},{name:'createdAt',type:'uint256'},{name:'status',type:'uint8'},{name:'posterRating',type:'uint8'}]}] },
